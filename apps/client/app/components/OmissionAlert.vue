...
const allEntities = computed(() => {
  ...
  props.articles.forEach((a) => {
    const entities = JSON.parse(a.entities || '[]') as string[];
    ...
    >
      ...
      <div class="space-y-2">
        <div class="flex flex-wrap gap-1 items-center">
          <span
            class="text-[10px] uppercase font-bold text-green-600 dark:text-green-400"
          >
            Mentioned:
          </span>
          <UBadge
        ...
        <div class="flex flex-wrap gap-1 items-center">
          <span
            class="text-[10px] uppercase font-bold text-red-600 dark:text-red-400"
          >
            Not Mentioned:
          </span>
          <UBadge
